package edu.towson.cosc.cosc455.jsadle5.lab4
...
class SyntaxAnalyzer {
  ...
  val ADJECTIVES: List[String] = List("happy", "mean", "fat", "hungry")
  val ADVERB: List[String] = List("quickly", "accidentally", "secretly");
